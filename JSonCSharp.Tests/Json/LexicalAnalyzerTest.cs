...
namespace JSonCSharp.Json.Tests
{
    ...
    public class LexicalAnalyzerTest
    {
        ...
        [DataTestMethod]
        [DataRow(".", "Unexpected char '.' at position 0")]
        [DataRow("tx", "Unexpected character 'x' at position 1. Keyword 'true' was expected.")]
        ...
        [DataRow(@"""\", @"Unexpected EOI at position 2")]
        [DataRow("0-", "Unexpected number format: Unexpected '-' at position 1")]
        [DataRow("-.", "Unexpected number format: Unexpected '.' at position 1")]
        [DataRow("0..", "Unexpected number format: Unexpected '.' at position 2")]
        [DataRow("0.0.", "Unexpected number format: Unexpected '.' at position 3")]
        [DataRow("0e0.0", "Unexpected number format: Unexpected '.' at position 3")]
        [DataRow("0+", "Unexpected number format at position 1")]
        [DataRow("0.0+", "Unexpected number format at position 3")]
        [DataRow("0e0+0", "Unexpected number format at position 3")]
        [DataRow("0e", "Unexpected number exponent format:  at position 2")]
        [DataRow("0e-", "Unexpected number exponent format: - at position 3")]
